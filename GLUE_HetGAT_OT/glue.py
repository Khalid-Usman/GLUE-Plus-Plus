...
from .nn import autodevice, sinkhorn_distance
...
class GLUETrainer(Trainer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.required_losses += ["ot_loss", "vae_loss", "total_loss"]
        ...
        self.lr = lr
        # Single optimizer for all parameters (no adversarial training)
        ...
        valid_optimizer_params = {
            ...
            'capturable', 'differentiable', 'fused', 'rho', 'lr_decay',
            'initial_accumulator_value', 'lambd', 't0', 'nesterov'
        }
        ...
        self.eidx: Optional[torch.Tensor] = None  
        self.enorm: Optional[torch.Tensor] = None  
        self.esgn: Optional[torch.Tensor] = None  
    ...
    def compute_losses(
        ...
        # Graph encoding and reconstruction
        ...
        # OT loss is computed in SCGLUE subclass
